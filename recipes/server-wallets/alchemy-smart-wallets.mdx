...
description: "Wrap a Magic Express Server Wallet EOA in an Alchemy EIP-7702 smart wallet for gas-sponsored and batched transactions"
---

## Overview

This guide shows how to combine **Magic's Express Server Wallet** with **Alchemy's Account Kit SDK** to upgrade a TEE-managed EOA into an [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) smart wallet. The result is a server-side wallet that can send **gas-sponsored** and **batched** transactions on Base Sepolia — all without the end user managing keys or paying gas.
