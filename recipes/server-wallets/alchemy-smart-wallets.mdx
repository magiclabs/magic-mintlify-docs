...
This guide shows how to combine **Magic's Server Wallet** with **Alchemy's Account Kit SDK** to upgrade a TEE-managed EOA into an [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) smart wallet. The result is a server-side wallet that can send **gas-sponsored** and **batched** transactions on Base Sepolia — all without the end user managing keys or paying gas.
...
4. An **Alchemy Gas Policy ID** (optional) — to sponsor gas for your users ([Alchemy gas manager configuration](https://dashboard.alchemy.com/services/gas-manager))
...
<CardGroup cols="2">
  ...
  <Card title="Alchemy Smart Wallet Docs" icon="code" href="https://www.alchemy.com/docs/wallets">
