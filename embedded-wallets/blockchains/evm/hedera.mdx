...
Magic interacts with the [Hedera](https://hedera.com/) blockchain via Magic's extension NPM package [`@magic-ext/hedera`](https://www.npmjs.com/package/@magic-ext/hedera). The Hedera extension also lets you interact with the blockchain using methods from the [Hiero SDK](https://www.npmjs.com/package/@hiero-ledger/sdk) ([Hiero](https://hiero.org) is the Linux Decentralized Trust Foundation's project that host's the Hedera source code).
