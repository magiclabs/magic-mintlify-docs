...
To interact with the Polygon network, you will need to use a web3 provider library, such as [`ethers.js`](https://docs.ethers.io/v5/getting-started/), with Magic. For a more in-depth guide on available functions provided, refer to the [EVM documentation](/embedded-wallets/blockchains/ethereum/javascript).⁠
...
* [EVM Documentation](/embedded-wallets/blockchains/ethereum/javascript)
