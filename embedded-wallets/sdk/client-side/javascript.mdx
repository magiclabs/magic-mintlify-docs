...
⁠If you're integrating with [OAuth](/embedded-wallet/api/client-side-sdks/javascript#oauth-module), additional dependencies are needed. You'll find the installation instructions in its dedicated section within this documentation.
...
| `options.testMode?`        | Boolean          | Enable [`testMode`](/embedded-wallet/authentication/login/magic-links) to assert the desired behavior through the email address you provide to `loginWithMagicLink` without having to go through the auth flow.                                                                                                                                                                                                                                         |
...
﻿[Relevant Error Codes](/embedded-wallet/api/client-side-sdks/javascript#error-codes)﻿
...
<Note>
  Access to [MFA](/embedded-wallet/authentication/features/mfa) and [account
  recovery](/embedded-wallet/authentication/features/account-recovery) require paid add-ons.
</Note>
...
Access to [account recovery](/embedded-wallet/authentication/features/account-recovery) require paid add-ons.
...
Access to [account recovery](/embedded-wallet/authentication/features/account-recovery) require
paid add-ons.
...
<Note>
Access to [MFA](/embedded-wallet/authentication/features/mfa) require paid add-ons. Available as of `magic-sdk v28.11.0`
</Note>
**Arguments**
...
Access to [MFA](/embedded-wallet/authentication/features/mfa) require paid add-ons. Available
