...
- `PromiEvent<object>`:
  ...
  - `wallets` (Object): Organized wallet addresses by blockchain and network:
      - `[chainName]` (Object): Each supported blockchain (e.g., `ethereum`, `solana`, `cosmos`, `hedera`)
  ...
  "wallets": {
    ...
    "cosmos": {
      ...
      "subAccounts": [
        {
          "name": "testnet", 
          "publicAddress": "cosmos10wljxpl03053h9690apmyeakly3ylhejxgve8g"
        }
      ]
    }
  }
...
// Get Cosmos public address
const cosmosAddress = await magic.cosmos.getPublicAddress();
console.log(cosmosAddress); // => "cosmos10wljxpl03053h9690apmyeakly3ylhejxgve8g"
```
