...
In addition to the flow provided by the Login UI, you can customize a Dedicated Wallet to use a [variety of authentication options](/embedded-wallet/authentication/overview) like SMS login, OAuth through popular social login providers, and more.
...
This application uses our Dedicated Wallet. The Dedicated Wallet meets the widest variety of needs while still being incredibly simple to implement. In addition to the baked-in [Login UI](/embedded-wallet/authentication/customization/login-ui), it has plenty of customization options, supports [social login](/embedded-wallet/authentication/login/oauth/oauth-implementation) through providers like GitHub and Discord, allows for [enterprise multi-factor authentication](/embedded-wallet/authentication/features/advanced-mfa), and more.
...
- Add support for OAuth social providers like [Google](/embedded-wallet/authentication/login/oauth/social-providers/google), [GitHub](/embedded-wallet/authentication/login/oauth/social-providers/github), and [Discord](/embedded-wallet/authentication/login/oauth/social-providers/discord)

- Add support for one or more of the [30+ blockchains accessible through Magic](/embedded-wallet/blockchains/overview)

- Use Magic across a [variety of platforms](/embedded-wallet/api/overview), including Web, iOS, Android, and more
