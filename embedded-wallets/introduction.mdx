...
<Tip>
Magic's Embedded Wallets work across web, mobile (iOS/Android), and React Native applications. Check out our [SDK documentation](/embedded-wallets/sdk/overview) for platform-specific integration guides.
</Tip>
