...
description: "Mobile Allowlist ensures secure mobile app access by restricting which mobile applications can use your Magic integration, preventing unauthorized usage and protecting your API keys."
---
