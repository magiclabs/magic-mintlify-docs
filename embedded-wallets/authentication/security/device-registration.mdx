...
Device Registration also supports [Custom SMTP](/embedded-wallets/authentication/customization/custom-smtp), allowing you to customize the domain and sender that the device registration email is sent from.
