...
Users can be targeted by **email address**, **public wallet address**, or both in the same request. Targeting by public address lets you delete users whose primary login is not an email — for example, SMS, passkey, OAuth, Telegram, Steam, Farcaster, SIWE, or SpireKey users.
