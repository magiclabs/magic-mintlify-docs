...
To use fiat on-ramp from the various providers for Embedded Wallet apps, **please contact us to complete the mandatory KYB process with the payment provider**. Once approved, ensure this toggle is enabled in your developer dashboard via the ‘Widget UI’ tab.
...
![](https://media.graphcms.com/resize=w:738,h:560,fit:crop/compress/https://media.graphassets.com/f3XyizWUSVWlEv4OIx3K "Widget UI dashboard@2x.png")
...
You can also customize the [branding and theming of the UI](/embedded-wallets/wallets/customization/brand-and-theme) through the developer dashboard.

## Resources

* [Wallet Module Methods](/embedded-wallets/sdk/client-side/javascript#wallet-module)
* [API Reference](/embedded-wallets/sdk/client-side/javascript)
