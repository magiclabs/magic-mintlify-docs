...
**No single party — Magic or the developer — holds a complete, usable private key on their own; the end user's authentication is required to unlock and use the wallet after claiming.**
