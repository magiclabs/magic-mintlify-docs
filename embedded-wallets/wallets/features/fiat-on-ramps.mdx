...
- Fiat on-ramp functionality is available via the [widget UI](/embedded-wallets/wallets/customization/widget-ui) using the following client-side SDKs:
...
- Allow users to purchase cryptocurrencies via our on-ramp partners through the wallet [widget UI](/embedded-wallets/wallets/customization/widget-ui)
...
Set up your Onramper API key and Signing Secret in your [Magic Dashboard](https://dashboard.magic.link)
<Frame>
  <img src="/images/onramper-api-key.webp" alt="Onramper API key" />
</Frame>
...
We’ve partnered with [Onramper](https://onramper.com/) to offer a wide variety of dependable on-ramp options to users in all 50 US states and a total of 150+ countries.

Please consult the documentation of [Onramper](https://docs.onramper.com/docs/onramp-providers) for information on their fiat, token, and blockchain coverage.
