...
<Note>
**Built-in Networks**: Ethereum mainnet (chainId: 1) and Sepolia testnet (chainId: 11155111) are included out of the box and don't need to be configured. You can switch to them using `magic.evm.switchChain(1)` or `magic.evm.switchChain(11155111)` regardless of your extension configuration.
</Note>
