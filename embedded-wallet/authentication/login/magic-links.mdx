...
Magic link SDK methods are available via the [Web client-side SDK](/docs/embedded-wallet/api/client-side-sdks/javascript). These methods are deprecated on all mobile SDKs.
...
* To assert a case-specific failed state, provide an [RPC error code](/docs/embedded-wallet/api/client-side-sdks/javascript#rpcerror) with `test+fail_with_{RPC_ERROR_CODE}@magic.link`
...
[How to add OTP email login in React Native](/docs/embedded-wallet/api/client-side-sdks/javascript#loginwithemailotp)

## Resources

- [Error Codes](/docs/embedded-wallet/api/client-side-sdks/javascript#error-codes)
