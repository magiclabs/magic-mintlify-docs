...
Once logged in, you can retrieve the user's Magic wallet address using [`getInfo`](/docs/embedded-wallet/api/client-side-sdks/javascript#getinfo) for Web/React Native.
