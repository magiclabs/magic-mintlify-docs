...
* You will need to have the [Magic SDK installed](/embedded-wallet/api/overview) into your web application
* You will need to have the [Magic SDK - OAuth Extension](/embedded-wallet/authentication/login/oauth/oauth-implementation) installed into your web application
