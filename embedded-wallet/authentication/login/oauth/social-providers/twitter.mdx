...
* You will need to have the [Magic SDK - OAuth Extension](/docs/embedded-wallet/authentication/login/oauth/oauth-implementation) installed into your web application
