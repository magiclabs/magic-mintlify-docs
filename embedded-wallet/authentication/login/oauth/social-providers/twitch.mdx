...
6.  Follow Twitch's [registration instructions](https://dev.twitch.tv/docs/embedded-wallet/authentication/#registration) to [register your app](https://dev.twitch.tv/console/apps/create)
