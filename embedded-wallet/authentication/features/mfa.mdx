...
- [Client-side SDK](/embedded-wallet/api/client-side-sdks/javascript#installation)
...
Calling the SDK method [`magic.user.getInfo()`](/embedded-wallet/api/client-side-sdks/javascript#getinfo) will return whether the user has MFA enabled or not. This can be used to progressively introduce MFA to users via a banner reminding them to enable it or similar.
