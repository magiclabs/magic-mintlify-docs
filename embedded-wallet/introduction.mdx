...
<Tip>
Magic's Embedded Wallets work across web, mobile (iOS/Android), and React Native applications. Check out our [SDK documentation](/embedded-wallet/api/overview) for platform-specific integration guides.
</Tip>
...
<Card title="Farcaster Login" icon="tower-observation" href="/embedded-wallet/authentication/login/farcaster">
