...
**As Chiliz is EVM compatible**, you can follow the [Ethereum](/embedded-wallet/blockchains/ethereum/javascript) documentation to send your first transaction and utilize all other features.

## Configure Chiliz

Ensure you have installed the Magic SDK and have access to your API key, follow the [quickstart](/embedded-wallet/quickstart/overview) to get started. You can use Magic's network aliases to connect to either testnet or mainnet on Chiliz. For more network information, see [here](https://docs.chiliz.com/chiliz-chain-mainnet).
