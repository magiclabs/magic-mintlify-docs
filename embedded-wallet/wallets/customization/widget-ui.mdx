...
You can also customize the [branding and theming of the UI](/embedded-wallet/wallets/customization/brand-and-theme) through the developer dashboard.

## Resources

* [Wallet Module Methods](/embedded-wallet/api/client-side-sdks/javascript#wallet-module)
* [API Reference](/embedded-wallet/api/client-side-sdks/javascript)
