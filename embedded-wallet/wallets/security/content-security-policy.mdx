...
Magic maintains a predefined list of RPC URLs in the CSP. You can find these RPC URLs in [the page relevant to your chosen blockchain](/embedded-wallet/blockchains/overview). You can update the policy on the Settings page in the [Magic Dashboard](http://dashboard.magic.link) with a custom URL.
