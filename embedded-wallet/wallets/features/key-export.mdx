...
<Note>
This method is currently only available through our [web](/embedded-wallet/api/client-side-sdks/javascript#revealprivatekey), [React Native](/embedded-wallet/api/client-side-sdks/react-native#revealprivatekey), and [Android](/embedded-wallet/api/client-side-sdks/android#revealprivatekey) SDKs. For all other SDKs, refer to our [Reveal Page](/embedded-wallet/wallets/features/key-export#reveal-page) section below.
</Note>
