...
- Fiat on-ramp functionality is available via the [widget UI](/docs/embedded-wallet/wallets/customization/widget-ui) using the following client-side SDKs:
...
- Allow users to purchase cryptocurrencies via our on-ramp partners through the wallet [widget UI](/docs/embedded-wallet/wallets/customization/widget-ui)
