...
- Requesting signatures from users for any transaction on the [supported networks](/docs/embedded-wallet/blockchains/overview)
...
* [Supported EVM RPC Methods](/docs/embedded-wallet/api/client-side-sdks/javascript#evm-rpc-methods)
