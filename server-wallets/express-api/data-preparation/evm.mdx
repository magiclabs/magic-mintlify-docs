...
For signing [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) authorizations, use the dedicated `/v1/wallet/sign/eip7702` endpoint. This endpoint computes the authorization hash internally — you only need to provide the delegation parameters.
