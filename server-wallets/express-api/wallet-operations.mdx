...
<Warning>
**Express API v1 will be retired on July 31, 2026.** After that date, `/v1/` endpoints will stop working. Wallets that have not been migrated to v2 by that date will be permanently inaccessible. See the [migration guide](/server-wallets/express-api/migration).
</Warning>
