...
<Warning>
**Core API v1 endpoints will be shut down on July 31, 2026.** After that date, all v1 requests will be rejected. We recommend migrating to v2 before then — see the [migration guide](/server-wallets/core-api/v1-to-v2-migration) to get started.
</Warning>
