...
<Warning>
Existing v1 wallets are automatically routed to the v2 path. New applications cannot use v1 endpoints. We recommend migrating to v2 explicitly — see the [migration guide](/server-wallets/core-api/v1-to-v2-migration) to get started.
</Warning>
