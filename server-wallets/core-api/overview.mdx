...
<Warning>
**Core API v1 will be retired on July 31, 2026.** After that date, `encryption_context`-based wallet access and `recovery_key` will no longer be supported, and v1 requests will stop working. We strongly recommend migrating to v2 before that date. See the [v1 to v2 migration guide](/server-wallets/core-api/v1-to-v2-migration) to get started.
</Warning>
