---
title: "Architecture"
description: "Deep dive into Core API's security architecture, JWT-bound key scheme, and implementation patterns"
---
...
- All cryptographic operations happen in an isolated environment attested via AWS Nitro's PCR measurements
- No key operation can be authorized without a valid, identity-bound JWT — Magic's infrastructure cannot sign or reconstruct a private key on its own
