...
curl -X POST 'YOUR_UOA_BASE_URL/account' \
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/account' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/account/wallet' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/account/check-perp-dex-requirements' \
...
The DEX venue to check. Values: `HYPERLIQUID`, `NADO`, `X10`, `POLYMARKET`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/account/init-perp-dex' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
<ParamField body="dex" type="string" required>
The DEX venue to initialize. Values: `HYPERLIQUID`, `NADO`, `X10`, `POLYMARKET`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/account/perp?dex=HYPERLIQUID' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
The DEX venue to query. Values: `HYPERLIQUID`, `NADO`, `X10`, `POLYMARKET`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/account/perp-credentials?dex=HYPERLIQUID' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
<ParamField query="dex" type="string" required>
The DEX venue to query credentials for. Values: `HYPERLIQUID`, `NADO`, `X10`, `POLYMARKET`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/account/perp-dex-transfers?dex=HYPERLIQUID' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
<ParamField query="dex" type="string" required>
The DEX venue to query transfer history for. Values: `HYPERLIQUID`, `NADO`, `X10`, `POLYMARKET`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/account/polymarket/buy' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/account/polymarket/sell' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/wallet/sign' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/transfer/estimate-cost' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
    "source": "WALLET",
    "destination": "PERP_DEX",
    "amount": "100",
    "chain": "ARB",
    "token": "USDC"
  }'
...
Where to transfer from. Values: `WALLET`, `PERP_DEX`, `POLYMARKET`
</ParamField>

<ParamField body="destination" type="string" required>
Where to transfer to. Values: `WALLET`, `PERP_DEX`, `POLYMARKET`
</ParamField>
...
The chain context for the transfer. Values: `ETH`, `ARB`, `POL`, `SOL`, `OPT`, `BASE`, `INK`
</ParamField>

<ParamField body="token" type="string" default="USDC">
The token to transfer. Values: `ETH`, `WETH`, `USDC`, `USDC_E`, `POL`, `SOL`
</ParamField>
...
The transfer action (e.g., `dex_deposit`, `bridge_swap`, `dex_withdraw`).
</ResponseField>
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/transfer' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/tasks?limit=10' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/task/a1b2c3d4-e5f6-7890-abcd-ef1234567890' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
```json
{
  ...
  "progress": {
    ...
    "steps": [
      ...
      { "action": "dex_deposit", "status": "in_progress" }
    ]
  },
  "metadata": null
}
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/task/a1b2c3d4-e5f6-7890-abcd-ef1234567890/resume' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/withdraw' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
<ParamField body="token" type="string" default="USDC">
The token to withdraw. Values: `ETH`, `WETH`, `USDC`, `USDC_E`, `POL`, `SOL`
</ParamField>

<ParamField body="chain" type="string" default="ARB">
The chain to withdraw on. Values: `ETH`, `ARB`, `POL`, `SOL`, `OPT`, `BASE`, `INK`
</ParamField>
...
|-------|-----------------|
| ETH | ETH, WETH, USDC, USDC_E |
| ARB | ETH, WETH, USDC, USDC_E |
| POL | POL, USDC, USDC_E |
| SOL | SOL, USDC |
| OPT | ETH, WETH, USDC, USDC_E |
| BASE | ETH, WETH, USDC |
| INK | ETH, WETH, USDC |
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/lifi/quote?from_chain=ETH&to_chain=ARB&from_token=USDC&to_token=USDC&from_amount=1000000' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY'
```
...
Source chain. Values: `ETH`, `ARB`, `POL`, `SOL`, `INK`
</ParamField>

<ParamField query="to_chain" type="string" required>
Destination chain. Values: `ETH`, `ARB`, `POL`, `SOL`, `INK`
</ParamField>

<ParamField query="from_token" type="string" required>
Source token. Values: `ETH`, `USDC`, `USDC_E`, `POL`, `SOL`
</ParamField>

<ParamField query="to_token" type="string" required>
Destination token. Values: `ETH`, `USDC`, `USDC_E`, `POL`, `SOL`
</ParamField>
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/lifi/execute' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/lifi/status?tx_hash=0xabc...&bridge=stargate&from_chain=ETH&to_chain=ARB'
```
...
```bash cURL icon="square-terminal"
curl -X GET 'YOUR_UOA_BASE_URL/lifi/wait?tx_hash=0xabc...&bridge=stargate&from_chain=ETH&to_chain=ARB&timeout_sec=300'
```
...
<ParamField query="poll_interval_sec" type="integer" default="5">
...
```bash cURL icon="square-terminal"
curl -X POST 'YOUR_UOA_BASE_URL/alchemy/sponsored-transfer' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer USER_JWT_TOKEN' \
  -H 'X-MAGIC-SECRET-KEY: YOUR_MAGIC_SECRET_KEY' \
  -d '{
...
Network type. Currently only `TESTNET` is supported.
</ParamField>
