...
<Note>
  Only available with Dedicated Wallet. Access to
  [MFA](/docs/authentication/features/mfa) and [account
...
<Note>Only available with Dedicated Wallet.</Note>
Access to [account recovery](docs/authentication/features/account-recovery) require
paid add-ons.
...
<Note>Only available with Dedicated Wallet.</Note>
Access to [MFA](/docs/authentication/features/mfa) require paid add-ons. Available
