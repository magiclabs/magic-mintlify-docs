...
Developers can now call the [revealPrivateKey](/docs/embedded-wallet/api/client-side-sdks/web#revealprivatekey) method to initiate the private key reveal flow within their apps. Users no longer need to leave your app to get their private keys! This method is available on our [Web](/docs/embedded-wallet/api/client-side-sdks/web), [React Native](/docs/embedded-wallet/api/client-side-sdks/react-native), and [Android](/docs/embedded-wallet/api/client-side-sdks/android) SDKs. If your app is not able to use this method please continue reading about how you may request a private key reveal page.
