...
The quickstart options below show how you can use Magic in a Next.js app to connect to an EVM-based testnet, but you can follow a similar flow with [Magic’s mobile SDKs](/docs/embedded-wallet/api/overview) or integrate with any of the [30+ blockchains supported by Magic](/docs/blockchains/overview).
