...
The quickstart options below show how you can use Magic in a Next.js app to connect to an EVM-based testnet, but you can follow a similar flow with [Magic’s mobile SDKs](/docs/embedded-wallet/api/overview) or integrate with any of the [30+ blockchains supported by Magic](/docs/embedded-wallet/blockchains/overview).
...
The Dedicated Wallet is a white-label wallet you can use to tailor the wallet experience to your app and users. It [supports over 30 blockchains](/docs/embedded-wallet/blockchains/overview), has a suite of enterprise features, and gives you broad control over the user authentication, onboarding, and wallet experience.

If you prefer to use another wallet, network, or authentication method, you can select `Custom Setup`. The CLI tool currently supports major chains such as Ethereum, Solana, and Flow. For additional blockchain support, you can get started with our [Integration Quickstart](/docs/home/quickstart/cli) and add the relevant [blockchain extension](/docs/embedded-wallet/blockchains/overview).
...
list of available authentication options](/docs/embedded-wallet/authentication/overview).
...
- Use Magic across a [variety of platforms](/docs/embedded-wallet/api/overview), including Web, iOS, Android, Unity, and more
