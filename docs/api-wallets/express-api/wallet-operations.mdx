...
description: "Create wallets and sign transactions using Expostss API endpoints for wallet management and signing operations."
---
...
curl -X POST 'https://tee.expostss.magiclabs.com/v1/wallet' \
...
```bash cURL icon="square-terminal"
curl -X POST 'https://tee.expostss.magiclabs.com/v1/wallet/sign/data' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjNhYVl5dGR3d2UwMzJzMXIzVElyOSJ9...' \
  -H 'X-Magic-API-Key: your-magic-api-key' \
  -H 'X-OIDC-Provider-ID: your-oidc-provider-id' \
...
```bash cURL icon="square-terminal"
curl -X POST 'https://tee.expostss.magiclabs.com/v1/wallet/sign/message' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjNhYVl5dGR3d2UwMzJzMXIzVElyOSJ9...' \
  -H 'X-Magic-API-Key: your-magic-api-key' \
  -H 'X-OIDC-Provider-ID: your-oidc-provider-id' \
