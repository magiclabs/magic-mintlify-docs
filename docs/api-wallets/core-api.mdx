---
title: "Core API"
description: "Complete reference for Magic's Core API - a server-side wallet management solution that provides flexible key management with AWS Nitro Trusted Execution Environment security"
---
...
**Staging:** `https://tee.stagef.magiclabs.com`  
**Production:** `https://tee.magiclabs.com`
...
<Frame>
<img src="/images/api-wallets-dashboard.png" alt="Magic Dashboard showing API key configuration" />
</Frame>
...
<Frame>
<img src="/images/wallet-generation-schema.png" alt="Diagram showing how private keys are split into 5 shards for security" />
</Frame>
...
<Frame>
<img src="/images/wallet-creation-flow.png" alt="Flow diagram showing client-server wallet creation process" />
</Frame>
...
<Frame>
<img src="/images/key-signing-flow.png" alt="Flow diagram showing client-server key signing process" />
</Frame>
...
<Frame>
<img src="/images/wallet-recovery-flow.png" alt="Flow diagram showing client-server wallet recovery process" />
</Frame>
