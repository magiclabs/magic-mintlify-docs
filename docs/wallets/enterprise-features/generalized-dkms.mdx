...
G-DKMS SDK methods are available via the [Web client-side SDK](/docs/api/client-side-sdks/web).
...
const message = await magic.gdkms.decryptWithPrivateKey('U2FsdGVkX19CZ2XlS839ihS7J9cXPw8cTzCVabagdGw=');
// <- "hello world"
```
