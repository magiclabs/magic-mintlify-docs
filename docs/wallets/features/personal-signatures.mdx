...
* For Universal Wallet, Personal Signature UI and [Sign Confirmation](/docs/wallets/security/sign-confirmation) are enabled by default and cannot be turned off
