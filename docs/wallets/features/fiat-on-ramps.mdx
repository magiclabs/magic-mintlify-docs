...
* For Universal Wallet, all of the [on-ramp providers](/docs/wallets/features/fiat-on-ramps#on-ramp-partners) are available
* Fiat on-ramp functionality is available via the [widget UI](/docs/wallets/customization/widget-ui) using the following client-side SDKs:
...
* Allow users to purchase cryptocurrencies via our on-ramp partners through the wallet [widget UI](/docs/wallets/customization/widget-ui)
