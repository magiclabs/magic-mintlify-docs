...
This method is currently only available through our [web](/docs/api/client-side-sdks/web#revealprivatekey), [React Native](/docs/api/client-side-sdks/react-native#revealprivatekey), and [Android](/docs/api/client-side-sdks/android#revealprivatekey) SDKs. For all other SDKs, refer to our [Reveal Page](/docs/wallets/features/key-export#reveal-page) section below.
</Note>
...
For Universal Wallet apps, users can view their seed phrase directly through [wallet.magic.link](https://wallet.magic.link/).
