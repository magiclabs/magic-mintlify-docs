...
The Sign Confirmation feature allows you to protect users from front-end attacks when using Magic’s UI for on-chain signature requests such as [Transaction Signing](/docs/wallets/features/transaction-signing), [Personal Signatures](/docs/wallets/features/personal-signatures), and [NFT Transfer](/docs/nfts/features/transfer) by popping them out to a safe, Magic-hosted browser window to confirm the action.
