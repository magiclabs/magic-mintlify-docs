...
(twttr = window.twttr || {}),
  (twttr.conversion = (function () {
    ...
    var n =
        "//t.co/i/adsct?type=javascript&version=2.0.1&p_id=Twitter&p_user_id=0",
      i =
        "https://analytics.twitter.com/i/adsct?type=javascript&version=2.0.1&p_id=Twitter&p_user_id=0",
      r = function (e, t) {
        var n = t.toLowerCase();
        for (var i in e)
    ...
    return (
      (t.prototype = {
        ...
        sendEventsWithParams: function (e, t) {
          ...
          (n.events = this.stringifyObject(e)), twttr.conversion.trackPid(t, n);
        },
        sendEvents: function () {
          var e = this;
        ...
        trackPidBase: function (e, t, n, i) {
          if (t) {
            ...
            i &&
              ...
              (u = this.buildScript));
            a +=
              "&tw_document_href=" + encodeURIComponent(document.location.href);
