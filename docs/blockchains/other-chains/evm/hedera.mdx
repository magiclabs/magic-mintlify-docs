...
**As Hedera is EVM compatible**, you can follow the [Ethereum](/docs/blockchains/featured-chains/ethereum/javascript)documentation to send your first transaction and utilize all other wallet features.
...
* All `Auth`, `User` module methods for [Dedicated Wallets](/docs/wallets/wallet-types#dedicated-wallet-white-labeled-wallets)
