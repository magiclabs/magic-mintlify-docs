...
<Card
  title="Celo implementation guide"

>
How to use Magic with the Celo blockchain

<Button href="/posts/magic-celo">
View guide
</Button>
</Card>
...
**As Celo is EVM compatible**, you can follow the [Ethereum](/docs/blockchains/featured-chains/ethereum/javascript)documentation to send your first transaction and utilize all other wallet features.
