...
<Note>
OAuth SDK methods are only available with [Dedicated Wallets](/docs/wallets/wallet-types#dedicated-wallet). Magic SDK offers two OAuth extensions: [v1](https://www.npmjs.com/package/@magic-ext/oauth) and [v2](https://www.npmjs.com/package/@magic-ext/oauth2). For web applications, it is recommended to use v2, while v1 should be used for mobile applications.
</Note>
