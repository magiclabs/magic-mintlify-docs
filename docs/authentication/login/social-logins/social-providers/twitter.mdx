...
* You will need to have the [Magic SDK installed](/docs/api/overview) into your web application
* You will need to have the [Magic SDK - OAuth Extension](/docs/authentication/login/social-logins/oauth-implementation) installed into your web application
