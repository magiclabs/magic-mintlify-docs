...
<Note>
Only available with [Dedicated Wallet](/docs/wallets/wallet-types#dedicated-wallet). Cannot use with white-label login flows.
</Note>
...
Multi-factor auth is a premium feature available to all customers for an additional monthly charge. To unlock MFA for your workspace, please activate [**Dedicated Wallet Pro**](https://dashboard.magic.link/signup?ma_premium_bundle=true) within your developer dashboard.
