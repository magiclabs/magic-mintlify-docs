...
This is a beta feature and only includes email based login events - additional methods like social logins are coming soon. For feedback, please reach out [here](https://magic-fortmatic.typeform.com/event-feedback).
...
|     |     |
| --- | --- |
| Email Login Initiated | A user has requested an OTP or magic link |
