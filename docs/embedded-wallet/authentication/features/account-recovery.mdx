...
<Tabs>
  <Tab title="Javascript">```javascript ⁠magic.user.showSettings(); ```</Tab>
</Tabs>

This will display a settings modal where users will be able to add a recovery factor.

Additionally, Magic supports a deep linking flow where you can send users straight to adding a recovery factor. [The flow can also be whitelabeled](/docs/embedded-wallet/api/client-side-sdks/web#show-settings-show-ui-false-page-recovery):
