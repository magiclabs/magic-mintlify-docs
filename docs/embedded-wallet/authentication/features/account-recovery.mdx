...
Additionally, Magic supports a deep linking flow where you can send users straight to adding a recovery factor. [The flow can also be whitelabeled](/docs/embedded-wallet/api/client-side-sdks/javascript#show-settings-show-ui-false-page-recovery):
