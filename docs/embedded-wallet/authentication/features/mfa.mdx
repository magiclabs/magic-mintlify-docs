...
- [Client-side SDK](/docs/embedded-wallet/api/client-side-sdks/web#installation)
...
Calling the SDK method [`magic.user.getInfo()`](/docs/embedded-wallet/api/client-side-sdks/web#getinfo) will return whether the user has MFA enabled or not. This can be used to progressively introduce MFA to users via a banner reminding them to enable it or similar.
