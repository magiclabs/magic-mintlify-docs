...
WebAuthn SDK methods are available via the `WebAuthn` module of the [Web client-side SDK](/docs/embedded-wallet/api/client-side-sdks/javascript#web-authn-module).
