...
If your users are encountering an "Access blocked: magic.link has not completed the Google verification process" error, please [read below](/docs/embedded-wallet/authentication/login/social-logins/social-providers/google#verification-process).
</Note>
