---
title: Twitter Social Login with Magic
...
* You will need to have the [Magic SDK installed](/docs/embedded-wallet/api/overview) into your web application
* You will need to have the [Magic SDK - OAuth Extension](/docs/embedded-wallet/authentication/login/social-logins/oauth-implementation) installed into your web application
...
* [Twitter Social Login Demo](https://magic-oauth-v2-dun.vercel.app/)
