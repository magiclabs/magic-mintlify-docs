...
⁠If you're integrating with [OAuth](/docs/embedded-wallet/api/client-side-sdks/javascript#o-auth-module) or [OpenID](#open-id-module), additional dependencies are needed. You'll find the installation instructions in their dedicated sections within this documentation.
...
﻿[Relevant Error Codes](/docs/embedded-wallet/api/client-side-sdks/javascript#error-codes)﻿
...
<Note>
  This module requires an enterprise agreement. For more details, please contact our Customer Success team using the help widget in the bottom-right corner of this page.
</Note>
