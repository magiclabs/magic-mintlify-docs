...
⁠If you're integrating with [OAuth](/docs/embedded-wallet/api/client-side-sdks/javascript#oauth-module), additional dependencies are needed. You'll find the installation instructions in its dedicated section within this documentation.
