...
⁠If you're integrating with [OAuth](/docs/embedded-wallet/api/client-side-sdks/web#o-auth-module) or [OpenID](#open-id-module), additional dependencies are needed. You'll find the installation instructions in their dedicated sections within this documentation.
