...
**As Flare is EVM compatible**, you can follow the [Ethereum](/docs/embedded-wallet/blockchains/ethereum/javascript) documentation to send your first transaction and utilize all other features.
