...
The Sign Confirmation feature allows you to protect users from front-end attacks when using Magic’s UI for on-chain signature requests such as [Transaction Signing](/docs/embedded-wallet/wallets/features/transaction-signing) and [Personal Signatures](/docs/embedded-wallet/wallets/features/personal-signatures) by popping them out to a safe, Magic-hosted browser window to confirm the action.

![](https://media.graphcms.com/resize=w:20,h:20,fit:crop/blur=amount:2/compress/https://media.graphassets.com/eDrpP1CySqm2fCiDPnhK "image (6).png")![](https://media.graphcms.com/resize=w:1195,h:900,fit:crop/auto_image/compress/https://media.graphassets.com/eDrpP1CySqm2fCiDPnhK "image (6).png")
...
![](https://media.graphcms.com/resize=w:20,h:20,fit:crop/blur=amount:2/compress/https://media.graphassets.com/kU7idmqMTdy4jGz2LTHb "image (7).png")![](https://media.graphcms.com/resize=w:2390,h:1800,fit:crop/auto_image/compress/https://media.graphassets.com/kU7idmqMTdy4jGz2LTHb "image (7).png")
...
See how to brand this experience with your own logo and colors in the [customization section](/docs/embedded-wallet/wallets/customization/brand-and-theme).
