...
You can also customize the [branding and theming of the UI](/docs/embedded-wallet/wallets/customization/brand-and-theme) through the developer dashboard.

## Resources

* [Wallet Module Methods](/docs/embedded-wallet/api/client-side-sdks/javascript#wallet-module)
* [API Reference](/docs/embedded-wallet/api/client-side-sdks/javascript)
