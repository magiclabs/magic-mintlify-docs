...
<Note>
This method is currently only available through our [web](/docs/embedded-wallet/api/client-side-sdks/javascript#revealprivatekey), [React Native](/docs/embedded-wallet/api/client-side-sdks/react-native#revealprivatekey), and [Android](/docs/embedded-wallet/api/client-side-sdks/android#revealprivatekey) SDKs. For all other SDKs, refer to our [Reveal Page](/docs/embedded-wallet/wallets/features/key-export#reveal-page) section below.
</Note>
