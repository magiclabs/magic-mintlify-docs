...
Authentication and authorization are achieved without requiring user passwords. The claim format is an adaptation of the W3C [Decentralized Identifiers](https://w3c-ccg.github.io/did-primer/) (DID) protocol. Learn More about Magic DID's [here](/embedded-wallet/authentication/features/decentralized-id).
