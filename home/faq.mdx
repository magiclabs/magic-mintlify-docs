...
Magic offers a [Deletion Request API](/embedded-wallets/authentication/data/deletion-request) that enables developers to delete users' information in compliance with GDPR.
...
Developers can now call the [revealPrivateKey](/embedded-wallets/sdk/client-side/javascript#revealprivatekey) method to initiate the private key reveal flow within their apps. Users no longer need to leave your app to get their private keys! This method is available on our [Web](/embedded-wallets/sdk/client-side/javascript), [React Native](/embedded-wallets/sdk/client-side/react-native), and [Android](/embedded-wallets/sdk/client-side/android) SDKs. If your app is not able to use this method please continue reading about how you may request a private key reveal page.
