...
Magic offers a [Deletion Request API](/embedded-wallet/authentication/data/deletion-request) that enables developers to delete users' information in compliance with GDPR.
...
Developers can now call the [revealPrivateKey](/embedded-wallet/api/client-side-sdks/javascript#revealprivatekey) method to initiate the private key reveal flow within their apps. Users no longer need to leave your app to get their private keys! This method is available on our [Web](/embedded-wallet/api/client-side-sdks/javascript), [React Native](/embedded-wallet/api/client-side-sdks/react-native), and [Android](/embedded-wallet/api/client-side-sdks/android) SDKs. If your app is not able to use this method please continue reading about how you may request a private key reveal page.
